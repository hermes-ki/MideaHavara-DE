...
Wenn deine Actions nicht automatisch starten, nutze einen externen Dienst, der deinen Workflow per workflow_dispatch via API-Call auslöst.

Das umgeht das Fork-Limit komplett.
